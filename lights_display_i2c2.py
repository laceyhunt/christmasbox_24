...
#    # Scale amplitude to be within the range of the dimmer array
#    max_amplitude = NUM_VALUES // 2
#    scaled_amplitude = min(amplitude, max_amplitude)
#
#    # Calculate the sine wave value with phase offset
#    sine_value = math.sin(2 * math.pi * frequency * time + phase)
#
#    # Scale and shift the sine wave to be within the range of the dimmer array
#    dimmer_value = int(max_amplitude + scaled_amplitude * sine_value)
#
#    return dimmer_value
